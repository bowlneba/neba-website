...
public static class OilPatternDtoFactory
{
    ...
    public static OilPatternDto Create(
    ...
    public static IReadOnlyCollection<OilPatternDto> Bogus(int count, int? seed = null)
    {
        var faker = new Faker<OilPatternDto>()
