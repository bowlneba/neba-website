...
public static class SeasonTournamentDtoFactory
{
    public static SeasonTournamentDto Create(
        ...
        IReadOnlyCollection<Name>? winners = null)
            => new()
            {
                ...
                Status = status?.Name ?? TournamentStatus.Scheduled.Name,
                TitleEligible = titleEligible ?? false,
        ...
        var faker = new Faker<SeasonTournamentDto>()
            .CustomInstantiator(f =>
            {
                ...
                return new()
                {
                    ...
                    Status = f.PickRandom(TournamentStatus.List.ToArray()).Name,
    ...
    public static IReadOnlyCollection<SeasonTournamentDto> Bogus(int count, Faker parentFaker)
    {
