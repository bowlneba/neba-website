...
public static class SponsorDetailTournamentDtoFactory
{
    ...
    public static SponsorDetailTournamentDto Create(
    ...
    internal static IReadOnlyCollection<SponsorDetailTournamentDto> Bogus(int count, Faker faker)
    {
        ...
        return [.. Enumerable.Range(0, count).Select(_ =>
        {
            ...
            return new SponsorDetailTournamentDto
            {
    ...
    public static IReadOnlyCollection<SponsorDetailTournamentDto> Bogus(int count, int? seed = null)
    {
        var faker = new Faker();
