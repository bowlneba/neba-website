...
public static class SponsorDetailTournamentViewModelFactory
{
    ...
    public static SponsorDetailTournamentViewModel Create(
    ...
    internal static IReadOnlyCollection<SponsorDetailTournamentViewModel> Bogus(int count, Faker faker)
    {
        ...
        return [.. Enumerable.Range(0, count).Select(_ =>
        {
            ...
            return new SponsorDetailTournamentViewModel
            {
    ...
    public static IReadOnlyCollection<SponsorDetailTournamentViewModel> Bogus(int count, int? seed = null)
    {
        var faker = new Faker();
