...
public static class BowlerSeasonStatsFactory
{
    ...
    {
        var faker = new Faker<BowlerSeasonStats>()
            .CustomInstantiator(f =>
            {
                ...
                return new BowlerSeasonStats
                {
                    SeasonId = new SeasonId(Ulid.BogusString(f)),
    ...
    public static IReadOnlyCollection<BowlerSeasonStats> Bogus(int count, Faker parentFaker)
    {
