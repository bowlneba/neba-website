...
public sealed class UploadTournamentLogoRequestValidatorTests
{
    private readonly UploadTournamentLogoRequestValidator _validator = new();
    ...
    {
        // Arrange
        var request = new UploadTournamentLogoRequest { File = CreateFile() };
    ...
    {
        // Arrange
        var request = new UploadTournamentLogoRequest { File = CreateFile(contentType: contentType) };
    ...
    public void Validate_ShouldFailWithFileRequired_WhenFileIsNull()
    {
        // Arrange
#nullable disable
        var request = new UploadTournamentLogoRequest { File = null };
#nullable enable
        ...
        result.Errors.ShouldContain(e => e.ErrorCode == "UploadTournamentLogoRequest.FileRequired");
    }
...
#nullable enable
    ...
    {
        // Arrange
        var request = new UploadTournamentLogoRequest { File = CreateFile(contentType: "application/pdf") };
    ...
    public void Validate_ShouldFailWithFileSizeExceedsLimit_WhenFileExceedsMaxSize()
    {
        ...
        var request = new UploadTournamentLogoRequest { File = CreateFile(length: maxSizeBytes + 1) };
    ...
    public void Validate_ShouldSucceed_WhenFileIsExactlyAtMaxSize()
    {
        // Arrange
        const long maxSizeBytes = 5 * 1024 * 1024;
        var request = new UploadTournamentLogoRequest { File = CreateFile(length: maxSizeBytes) };
    ...
    {
        // Arrange
        var request = new UploadTournamentLogoRequest { File = CreateFile(length: 0) };
