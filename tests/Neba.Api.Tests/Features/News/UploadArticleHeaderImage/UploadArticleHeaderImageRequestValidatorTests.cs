...
[UnitTest]
[Component("News")]
public sealed class UploadArticleHeaderImageRequestValidatorTests
{
    private readonly UploadArticleHeaderImageRequestValidator _validator = new();
    ...
    {
        // Arrange
        var request = new UploadArticleHeaderImageRequest { File = CreateFile() };
    ...
    {
        // Arrange
        var request = new UploadArticleHeaderImageRequest { File = CreateFile(contentType: contentType) };
    ...
    public void Validate_ShouldFailWithFileRequired_WhenFileIsNull()
    {
        // Arrange
#nullable disable
        var request = new UploadArticleHeaderImageRequest { File = null };
#nullable enable
        ...
        result.Errors.ShouldContain(e => e.ErrorCode == "UploadArticleHeaderImageRequest.FileRequired");
    }
...
#nullable enable
    ...
    {
        // Arrange
        var request = new UploadArticleHeaderImageRequest { File = CreateFile(contentType: "application/pdf") };
    ...
    public void Validate_ShouldFailWithFileSizeExceedsLimit_WhenFileExceedsMaxSize()
    {
        ...
        var request = new UploadArticleHeaderImageRequest { File = CreateFile(length: maxSizeBytes + 1) };
    ...
    public void Validate_ShouldSucceed_WhenFileIsExactlyAtMaxSize()
    {
        // Arrange
        const long maxSizeBytes = 5 * 1024 * 1024;
        var request = new UploadArticleHeaderImageRequest { File = CreateFile(length: maxSizeBytes) };
    ...
    {
        // Arrange
        var request = new UploadArticleHeaderImageRequest { File = CreateFile(length: 0) };
