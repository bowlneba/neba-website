...
public sealed record FullStatModalRowDto
{
    ...
    /// <summary>Bowler of the Year points accumulated during the season.</summary>
    public required int Points { get; init; }

    /// <summary>Pre-computed overall pin average across all games in the season.</summary>
