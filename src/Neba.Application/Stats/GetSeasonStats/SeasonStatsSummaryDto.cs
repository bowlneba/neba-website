...
public sealed record SeasonStatsSummaryDto
{
    ...
    /// </summary>
    public required int TotalPrizeMoney { get; init; }
    ...
    /// </summary>
    public required IReadOnlyDictionary<BowlerId, string> HighGameBowlers { get; init; }
    ...
    /// </summary>
    public required IReadOnlyDictionary<BowlerId, string> HighBlockBowlers { get; init; }
    ...
    /// </summary>
    public required IReadOnlyDictionary<BowlerId, string> HighAverageBowlers { get; init; }
    ...
    /// </summary>
    public required IReadOnlyDictionary<BowlerId, string> HighestMatchPlayWinPercentageBowlers { get; init; }
    ...
    /// </summary>
    public required IReadOnlyDictionary<BowlerId, string> MostFinalsBowlers { get; init; }
}