...
/// <summary>
/// Represents a snapshot of a bowler's season statistics, including various performance metrics, points earned towards awards, and other relevant information for the season. This record is designed to be immutable and provides a comprehensive overview of a bowler's performance during a specific season, which can be used for ranking, award eligibility, and historical reference within the application.
/// </summary>
public record BowlerSeasonStatsSnapshot
{
    /// <summary>
