...
/// <summary>
/// Summary of a single tournament for display in the tournament schedule.
/// </summary>
public sealed record SeasonTournamentViewModel
{
    ...
    /// <summary>
    /// Season label, e.g. "2026" or "2020-21".
    /// </summary>
    ...
    /// <summary>
    /// Format category of the tournament (e.g., "Singles", "Doubles", "Senior / Women").
    /// </summary>
    ...
    /// <summary>
    /// Name of the oil pattern used (public portion only).
    /// </summary>
    ...
    /// <summary>
    /// Pattern ratio category (public portion only).
    /// </summary>
    ...
    /// <summary>
    /// Names of the winning bowler(s); empty when results are not yet available.
    /// </summary>
    ...
    /// <summary>
    /// True when a sponsor is assigned.
    /// </summary>
    ...
    /// <summary>
    /// True when this entry belongs to the merged 2020-21 COVID season.
    /// </summary>
    public bool IsMergedSeason => Season == "2020-21";

    /// <summary>
    /// Whole days remaining until start (0 if today or past).
    /// </summary>
    public int DaysUntilStart =>
        Math.Max(0, (StartDate.ToDateTime(TimeOnly.MinValue) - DateTime.Today).Days);

    /// <summary>
    /// True when start is within 21 days and has not passed.
    /// </summary>
    ...
    /// <summary>
    /// Label for the primary price display ("Added money" or "Entry fee").
    /// </summary>
    public string DisplayPriceLabel => HasAddedMoney ? "Added money" : "Entry fee";

    /// <summary>
    /// Primary price to display (added money takes precedence over entry fee).
    /// </summary>
