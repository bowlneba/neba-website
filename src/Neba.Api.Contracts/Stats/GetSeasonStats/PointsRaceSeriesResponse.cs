...
/// <summary>A single bowler's Bowler of the Year points race series for the Season, showing cumulative points earned after each tournament.</summary>
public sealed record PointsRaceSeriesResponse
{
    ...
    /// <summary>The ordered sequence of tournament results, each showing the cumulative Bowler of the Year points after that tournament.</summary>
