...
public sealed record HighBlockResponse
{
    ...
    /// <summary>
    /// The highest 5-game qualifying block score the bowler achieved across all tournaments in the Season.
    /// </summary>
    public required int HighBlock { get; init; }

    /// <summary>
    /// The highest single qualifying game the bowler bowled across all tournaments in the Season.
    /// </summary>
