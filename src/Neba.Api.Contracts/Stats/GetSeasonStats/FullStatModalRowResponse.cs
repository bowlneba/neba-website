...
public sealed record FullStatModalRowResponse
{
    ...
    /// <summary>
    /// Total Bowler of the Year (Open) points accumulated during the Season.
    /// </summary>
    public required int Points { get; init; }

    /// <summary>
    /// The bowler's overall average (total pinfall divided by total games) for the Season.
    /// </summary>
    ...
    /// <summary>
    /// Total head-to-head match play victories recorded across all Finals appearances in the Season.
    /// </summary>
    public required int Wins { get; init; }

    /// <summary>
    /// Total head-to-head match play defeats recorded across all Finals appearances in the Season.
    /// </summary>
    public required int Losses { get; init; }

    /// <summary>
    /// Win percentage in match play for the Season (wins divided by total matches, expressed as a percentage).
    /// </summary>
    public required decimal WinPercentage { get; init; }

    /// <summary>
    /// The bowler's match play average (match play pinfall divided by match play games) for the Season. Zero if the bowler did not reach Finals.
    /// </summary>
    ...
    /// <summary>
    /// Total tournaments the bowler participated in during the Season.
    /// </summary>
