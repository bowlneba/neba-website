...
public sealed record MatchPlayAverageResponse
{
    ...
    /// <summary>
    /// The bowler's match play average (match play pinfall divided by match play games) for the Season.
    /// </summary>
    public required decimal MatchPlayAverage { get; init; }

    /// <summary>
    /// Total individual match play games bowled across all Finals appearances in the Season.
    /// </summary>
