...
public interface IAwardsApi
{
    ...
    /// <returns>A collection of Bowler of the Year awards.</returns>
    ...
    /// </summary>
    /// <param name="cancellationToken">A token to cancel the operation.</param>
    /// <returns>A collection of High Block awards.</returns>
    ...
    /// </summary>
    /// <param name="cancellationToken">A token to cancel the operation.</param>
    /// <returns>A collection of High Average awards.</returns>
