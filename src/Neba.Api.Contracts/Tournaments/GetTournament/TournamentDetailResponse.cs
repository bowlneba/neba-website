...
/// <summary>
/// Full details for a tournament, including schedule, entry info, sponsors, oil patterns, and results.
/// </summary>
public sealed record TournamentDetailResponse
{
    ...
    /// <summary>
    /// Total entries in the tournament; null for upcoming events or if not tracked.
    /// </summary>
    ...
    /// </summary>
    public IReadOnlyCollection<TournamentDetailSponsorResponse> Sponsors { get; init; } = [];
