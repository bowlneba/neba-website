...
/// <summary>
/// The fields required to edit an existing tournament. Identical to <see cref="TournamentInput"/> —
/// every field on a tournament is editable, so nothing is excluded here.
/// </summary>
public sealed record EditTournamentInput
{
    /// <summary>
    ...
    /// <summary>
    /// The tournament's logo image, already uploaded to storage; null to remove the current logo.
    /// </summary>
