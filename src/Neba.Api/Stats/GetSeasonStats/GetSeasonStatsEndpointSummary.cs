    ...
    public GetSeasonStatsEndpointSummary()
    {
        ...
        Response(200, "The season statistics.",
            ...
            example: new GetSeasonStatsResponse
            {
                ...
                SeasonsBests = new SeasonBestsResponse { HighGame = 279, HighGameBowlers = ["Jane Smith"], HighBlock = 1250, HighBlockBowlers = ["Jane Smith"], HighAverage = 225.35m, HighAverageBowlers = ["Jane Smith"] },
                FieldMatchPlaySummary = new FieldMatchPlaySummaryResponse { HighestWinPercentage = 66.67m, HighestWinPercentageBowlers = ["Jane Smith"], MostFinals = 5, MostFinalsBowlers = ["Jane Smith"] },
