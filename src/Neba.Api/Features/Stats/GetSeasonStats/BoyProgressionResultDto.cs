...
{
    /// <summary>
    /// The bowler's unique identifier.
    /// </summary>
    ...
    /// <summary>
    /// The bowler's date of birth, used for age-gated race eligibility (Senior, SuperSenior, Youth).
    /// </summary>
    public required DateOnly? BowlerDateOfBirth { get; init; }

    /// <summary>
    /// The bowler's gender, used for Woman race eligibility.
    /// </summary>
    ...
    /// <summary>
    /// The tournament's start date. Used for ordering results chronologically.
    /// </summary>
    public required DateOnly TournamentDate { get; init; }

    /// <summary>
    /// The tournament's end date. Age eligibility for Senior, SuperSenior, and Youth races is evaluated against this date.
    /// </summary>
    public required DateOnly TournamentEndDate { get; init; }

    /// <summary>
    /// Whether the tournament counts toward the Open BOY race.
    /// </summary>
    public required bool StatsEligible { get; init; }

    /// <summary>
    /// The tournament type, used for specialty-race eligibility.
    /// </summary>
    public required int TournamentType { get; init; }

    /// <summary>
    /// The raw points listed on this result row.
    /// </summary>
    public required int Points { get; init; }

    /// <summary>
    /// The side cut identifier, or <c>null</c> if this is a main-cut result.
    /// </summary>
