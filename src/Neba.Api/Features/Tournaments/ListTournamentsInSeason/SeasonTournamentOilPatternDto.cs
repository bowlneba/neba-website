...
/// </summary>
public sealed record SeasonTournamentOilPatternDto
{
    /// <summary>
    ...
    /// <summary>
    /// Gets the Kegel pattern ID if this pattern is associated with a Kegel pattern in the Kegel API; null if there is no association.
    /// </summary>
