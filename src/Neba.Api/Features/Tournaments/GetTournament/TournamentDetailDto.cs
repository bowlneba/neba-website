...
public sealed record TournamentDetailDto
{
    ...
    /// </summary>
    public required TournamentDetailBowlingCenterDto? BowlingCenter { get; init; }
    ...
    /// <summary>
    /// Results for bowlers in this tournament; empty for pending/upcoming events.
    /// </summary>
    public IReadOnlyCollection<TournamentResultDto> Results { get; init; } = [];
