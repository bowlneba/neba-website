...
internal interface IFileStorageService
{
    ...
    /// The storage container name (e.g., "bowlneba-private").
    /// </param>
    /// <param name="path">
    ...
    /// </param>
    /// <returns>
    /// The file content and metadata, or <c>null</c> if the file does not exist.
    /// </returns>
    ...
    /// The MIME content type (e.g., "text/html").
    /// </param>
    /// <param name="metadata">
