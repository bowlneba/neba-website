    ...
    public string ToHtmlBody()
    {
        ...
        return EmailLayout.Wrap($"""
            ...
            <div style="text-align:center;margin:36px 0 28px;">
              <div style="display:inline-block;background:#f0f4fb;border:2px solid #1a3a6e;border-radius:6px;padding:16px 44px;font-size:22px;font-weight:700;letter-spacing:2px;color:#1a3a6e;font-family:'Courier New',monospace;">
                {password}
              </div>
            </div>
