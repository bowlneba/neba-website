...
public interface IBackgroundJobScheduler
{
    ...
    /// </param>
    /// <returns>
    /// The identifier of the enqueued job.
    /// </returns>
    ...
    /// </typeparam>
    /// <param name="job">
    /// The background job to schedule.
    /// </param>
    /// <param name="delay">
    /// The delay after which the job should be executed.
    /// </param>
    /// <returns>
    ...
    /// The date and time at which the job should be executed.
    /// </param>
    /// <returns>
    /// The identifier of the scheduled job.
    /// </returns>
    ...
    /// The identifier of the recurring job.
    /// </param>
    /// <param name="job">
    /// The background job to add or update.
    /// </param>
    ...
    /// </summary>
    /// <param name="recurringJobId">
    /// The identifier of the recurring job to remove.
    /// </param>
    ...
    /// </param>
    /// <param name="job">
    /// The background job to schedule as a continuation.
    /// </param>
    /// <returns>
    /// The identifier of the continuation job.
    /// </returns>
