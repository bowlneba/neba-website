        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    business_phone_type = table.Column<string>(type: "character(1)", fixedLength: true, maxLength: 1, nullable: true),
                    business_phone_country_code = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: true),
                    business_phone_number = table.Column<string>(type: "character varying(15)", maxLength: 15, nullable: true),
                    business_phone_extension = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    business_fax_type = table.Column<string>(type: "character(1)", fixedLength: true, maxLength: 1, nullable: true),
                    business_fax_country_code = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: true),
                    business_fax_number = table.Column<string>(type: "character varying(15)", maxLength: 15, nullable: true),
                    business_fax_extension = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
