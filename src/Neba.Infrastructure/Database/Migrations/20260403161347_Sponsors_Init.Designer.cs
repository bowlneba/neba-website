...
namespace Neba.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260403161347_Sponsors_Init")]
    partial class Sponsors_Init
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Neba.Domain.Sponsors.Sponsor", b =>
                {
                    ...
                    b.OwnsOne("Neba.Domain.Contact.PhoneNumber", "FaxNumber", b1 =>
                        {
                            b1.Property<int>("Sponsordb_id")
                                .HasColumnType("integer")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Neba.Domain.Contact.PhoneNumber", "PhoneNumber", b1 =>
                        {
                            b1.Property<int>("Sponsordb_id")
                                .HasColumnType("integer")
                                .HasColumnName("id");
