...
{
    /// <inheritdoc />
    public partial class BowlingCenter_Init : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // NOTE: Column declarations are intentionally grouped for readability and physical table layout.
            // Mapping extension methods can interleave property discovery order, so configuration order
            // alone is not a reliable way to control generated column order.
