...
export default defineConfig({
  ...
  webServer: [
    ...
    {
      command:
        'NebaApi__BaseUrl=http://localhost:5151 AzureMaps__SubscriptionKey=mock-key-for-e2e dotnet run --project src/Neba.Website.Server --configuration Release --urls https://localhost:5200',
