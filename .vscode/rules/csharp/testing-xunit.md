...
- Use `NSubstitute` library for mocking
    ...
    public sealed class SomeClassTests
    {
        ...
        public SomeClassTests()
        {
            ...
            _someClass = new SomeClass(_mockDependency);
        }
    }
    ```
...
- Name tests clearly:
    ...
    [Fact]
    public async Task ProcessOrder_WhenInventoryAvailable_ShouldUpdateStockAndReturnsSuccess()
